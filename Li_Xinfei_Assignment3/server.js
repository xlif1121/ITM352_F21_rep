...
app.post("/confirm", function (req, res) {
 ...
 // send to invoice.html
    ...
    // Borrowed and modified from Assignment 3 Example Codes
    ...
    transporter.sendMail(mailOptions, function (error, info) {
      if (error) {
        ...
        status_str += `<br>Your invoice was mailed to ${user_data[username].email}`;
      }
...
//Creating an invoice to both print and email--from as3 code examples---incomplete
